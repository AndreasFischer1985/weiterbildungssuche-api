...
class ResponseEmbeddedTermineInnerAnsprechpartnerInnerRollen(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ResponseEmbeddedTermineInnerAnsprechpartnerInnerRollen - a model defined in OpenAPI
