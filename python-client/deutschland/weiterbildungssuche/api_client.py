...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.weiterbildungssuche  # this is an instance of the class Endpoint
        api_instance.weiterbildungssuche()  # this invokes api_instance.weiterbildungssuche.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.weiterbildungssuche.callable or self.callable in this class
