...
from deutschland.weiterbildungssuche import rest
...
from deutschland.weiterbildungssuche.model_utils import (
    ModelComposed,
    ModelNormal,
    ModelSimple,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.pc_v1_bildungsangebot_get  # this is an instance of the class Endpoint
        api_instance.pc_v1_bildungsangebot_get()  # this invokes api_instance.pc_v1_bildungsangebot_get.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.pc_v1_bildungsangebot_get.callable or self.callable in this class
