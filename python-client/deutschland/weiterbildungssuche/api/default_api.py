...
class DefaultApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.pc_v1_bildungsangebot_get_endpoint = _Endpoint(
            settings={
                "response_type": (Response,),
                "auth": ["clientCredAuth"],
                "endpoint_path": "/pc/v1/bildungsangebot",
                "operation_id": "pc_v1_bildungsangebot_get",
                "http_method": "GET",
                "servers": None,
            },
            params_map={
    ...
    def pc_v1_bildungsangebot_get(self, **kwargs):
        ...
        >>> thread = api.pc_v1_bildungsangebot_get(async_req=True)
        >>> result = thread.get()
        ...
        return self.pc_v1_bildungsangebot_get_endpoint.call_with_http_info(**kwargs)
